...
class EffectTrigger(Enum):
    ...
    ADDITIONAL_COST    = auto()   # fired when an ATTACK action card is played (before defend, for additional costs)
...
class EffectAction(Enum):
    ...
    ATTACK_POWER_BOOST_IF_LOWER_LIFE   = auto()   # this attack gains +magnitude power if the attacker has less life than the defender
