...
CARD_CATALOG: Dict[str, Card] = {
    ...
    "bare_fangs_red": Card("Bare Fangs", [CardType.ATTACK, CardType.ACTION], cost=2, pitch=1,
    ...
    "wild_ride_red": Card("Wild Ride", [CardType.ATTACK, CardType.ACTION], cost=2, pitch=1,
                          power=6, defense=0, color=Color.RED, no_block=True,
                          card_class=CardClass.BRUTE,
    ...
    "wrecking_ball_red": Card("Wrecking Ball", [CardType.ATTACK, CardType.ACTION], cost=3, pitch=1,
                              power=6, defense=0, color=Color.RED, no_block=True,
                              card_class=CardClass.BRUTE,
    ...
    "muscle_mutt_yellow": Card("Muscle Mutt", [CardType.ATTACK, CardType.ACTION], cost=3, pitch=2,
                               power=6, defense=2, color=Color.YELLOW,
                               card_class=CardClass.GENERIC,
                               text=""),

    "pack_call_yellow": Card("Pack Call", [CardType.ATTACK, CardType.ACTION], cost=3, pitch=2,
    ...
    "raging_onslaught_yellow": Card("Raging Onslaught", [CardType.ATTACK, CardType.ACTION], cost=3, pitch=2,
                                    power=6, defense=3, color=Color.YELLOW,
                                    card_class=CardClass.GENERIC,
                                    text=""),

    "smash_instinct_yellow": Card("Smash Instinct", [CardType.ATTACK, CardType.ACTION], cost=3, pitch=2,
                                  power=6, defense=3, color=Color.YELLOW,
                                  card_class=CardClass.BRUTE,
                                  keywords=[Keyword.INTIMIDATE],
                                  text="Intimidate."),

    "smash_with_big_tree_yellow": Card("Smash with Big Tree", [CardType.ATTACK, CardType.ACTION], cost=2, pitch=2,
    ...
    "rally_the_rearguard_blue": Card("Rally the Rearguard", [CardType.ATTACK, CardType.ACTION], cost=2, pitch=3,
    ...
    "wrecker_romp_blue": Card("Wrecker Romp", [CardType.ATTACK, CardType.ACTION], cost=2, pitch=3,
    ...
    "flock_of_the_feather_walkers_red": Card(
        "Flock of the Feather Walkers", [CardType.ATTACK, CardType.ACTION], cost=1, pitch=1,
    ...
    "out_for_blood_yellow": Card("Out for Blood", [CardType.ATTACK_REACTION], cost=1, pitch=2,
                                 ...
                                 play_condition=lambda ctx: ctx.get("is_weapon_attack", False),
                                 effects=[
